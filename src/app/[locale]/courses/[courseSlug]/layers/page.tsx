    ...
    <div className="space-y-8">
      <section>
        ...
        <h1 className="mt-2 text-2xl font-bold text-[color:var(--color-text)] sm:text-3xl">
          {isZh ? `${data.project.title} 的结构地图` : `Structure map of ${data.project.title}`}
        </h1>
      ...
      <KnowledgeMap categories={data.categories} modules={data.modules} locale={params.locale} basePath={basePath} />
    </div>
  );
}
