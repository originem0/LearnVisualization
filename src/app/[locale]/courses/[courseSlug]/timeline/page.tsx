...
import { getCategoriesById, getCourseData } from '@/lib/data';
...
export default function CourseTimelinePage({ params }: { params: { locale: Locale; courseSlug: string } }) {
  ...
  return (
    <div className="space-y-10">
      ...
      <BarChart modules={data.modules} categoriesById={categoriesById} locale={params.locale} basePath={basePath} />
    </div>
  );
}
