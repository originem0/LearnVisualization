      ...
      <div className="mt-3 flex gap-2">
        ...
        {checked && !allCorrect && (
          <button
            ...
            className="flex-1 rounded-lg border border-[color:var(--color-border)] py-2 text-xs font-medium text-[color:var(--color-text)] transition hover:bg-[color:var(--color-bg)]"
          >
            继续调整
          </button>
        )}
